...
export const HeroSection = () => {
  return <section className="relative min-h-[90vh] sm:min-h-screen flex items-center bg-gradient-to-br from-primary via-cta-green to-primary overflow-hidden py-12 sm:py-16 md:py-20">
      <GoldPattern />
      <AnimatedOrbs />
          ...
          duration: 0.8
            ...
            delay: 0.5
              ...
              <div className="relative">
                <img alt="Ebook 51 Formas de Renda Extra" className="w-full max-w-[280px] drop-shadow-2xl relative z-10" src="/lovable-uploads/b86fc511-39c5-4c76-86b8-9b2a6ccff3b4.jpg" />
            ...
            delay: 0.4
              ...
              <Button variant="cta-gold" size="xl" className="w-full sm:w-auto text-xs sm:text-sm md:text-base px-6 sm:px-8 md:px-12 h-14 sm:h-14 md:h-16 max-w-[320px] sm:max-w-none mx-auto sm:mx-0" asChild>
          ...
          delay: 0.3
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-gold-light to-gold p-2 rounded-3xl shadow-luxury rotate-3 hover:rotate-0 transition-transform duration-500">
                <img src="https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?auto=format&fit=crop&q=80&w=800" alt="Pessoa conquistando renda extra" className="rounded-2xl w-full h-auto" />
              </div>
