...
export const FinalCTA = () => {
  return (
    <section className="relative py-12 sm:py-16 md:py-24 lg:py-32 bg-gradient-to-br from-primary via-cta-green to-primary overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,_rgba(212,175,55,0.1)_0%,_transparent_70%)]" />
      <div className="container mx-auto max-w-[1100px] px-3 sm:px-4 md:px-6 relative z-10">
        <motion.div
        ...
        >
          <div className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-[28px] text-primary-foreground leading-relaxed space-y-3 sm:space-y-4 md:space-y-5 lg:space-y-6 px-2 sm:px-0">
            <p>
